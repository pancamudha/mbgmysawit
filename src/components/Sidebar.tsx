...
export default function Sidebar() {
  return (
    ...
    <aside className="fixed left-0 top-[60px] bg-[#0A0A0A]/80 backdrop-blur-xl z-40 h-[calc(100vh-60px)] py-6 px-3 flex flex-col items-start gap-2 border-r border-[#2A2A2E] w-[240px] -translate-x-full [.sidebar-expanded_&]:translate-x-0 transition-transform duration-300 ease-in-out shadow-2xl">
      ...
      {/* Home (Aktif) - Background disamakan dengan input search (#0F0F0F) */}
      <Link href="/" className="flex items-center gap-4 p-3 w-full text-white bg-[#0F0F0F] border border-[#2A2A2E] rounded-xl hover:bg-[#161616] transition-colors group shadow-sm" title="Home">
      ...
      {/* Explore - Icon diubah jadi Compass */}
      <Link href="/explore" className="flex items-center gap-4 p-3 w-full text-[#8C8C8C] hover:text-white hover:bg-[#0F0F0F] rounded-xl transition-colors group" title="Explore">
        <svg className="w-[22px] h-[22px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Schedule */}
      <Link href="/schedule" className="flex items-center gap-4 p-3 w-full text-[#8C8C8C] hover:text-white hover:bg-[#0F0F0F] rounded-xl transition-colors group" title="Schedule">
        <svg className="w-[22px] h-[22px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* History */}
      <Link href="/history" className="flex items-center gap-4 p-3 w-full text-[#8C8C8C] hover:text-white hover:bg-[#0F0F0F] rounded-xl transition-colors group" title="History">
        <svg className="w-[22px] h-[22px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
