...
export default function WelcomeBanner() {
  ...
  return (
    <>
      ...
      {/* PERUBAHAN DI SINI: Container utama dibuat flex-col dan overflow-hidden agar menyatu dengan iklan */}
      <div className="w-full bg-[#121212] border border-[#282828] rounded-lg mb-5 flex flex-col shadow-sm transition-colors duration-300 overflow-hidden">
        
        {/* PADDING tetap p-2.5 sm:p-3 dipindah ke sini agar layout asli tidak bergeser 1px pun */}
        <div className="w-full p-2.5 sm:p-3 flex items-center justify-between border-b border-[#282828]">
          {/* Kiri: Avatar & Teks */}
        ...
        {/* PERUBAHAN DI SINI: Slot Iklan ditaruh di dalam container WelcomeBanner */}
        <div className="w-full flex justify-center items-center min-h-[90px] bg-[#0F0F0F]">
          <AdsterraBanner />
        </div>
