...
export default function WelcomeBanner() {
  return (
    // PADDING DIUBAH menjadi p-2.5 sm:p-3 agar jarak atas, bawah, kiri, dan kanan SAMA RATA
    <div className="w-full bg-[#121212] border border-[#282828] rounded-lg p-2.5 sm:p-3 mb-5 flex items-center justify-between shadow-sm transition-colors duration-300">
      ...
      <div className="flex items-center gap-3 sm:gap-3.5">
        ...
        <div className="flex flex-col justify-center">
          <h3 className="text-white font-bold text-[13px] sm:text-[14px] leading-tight mb-0.5">Welcome to Animaple!</h3>
          <p className="text-[#8C8C8C] text-[10px] sm:text-[11px] font-medium leading-tight">Enjoy watching your favorite anime.</p>
        </div>
      </div>
